...
Если хотите узнать, какие версии библиотек нужны для данного пакеты, обратитесь в файл `requirements.txt`

В данном пакете создан файл `pyproject.toml`, поэтому `pyproject.toml` автоматически использует информацию из `requirements.txt`, если он присутствует.
...
![Пример ииспользования функции help()](image/2024-07-03_16-26-06.png)

 **Примеры вывода графика и изображения**
![Пример вывода графика "количество областей на кадре в зависимости от времени".](image/2024-07-03_16-26-26.png)

![Пример вывода графика "количество областей на кадре в зависимости от времени".](image/2024-07-03_16-27-06.png)
